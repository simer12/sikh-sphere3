        ...
        <Card style={styles.streamCard}>
          <Card.Content style={styles.streamCardContent}>
            ...
            <View style={styles.locationContainer}>
              ...
              <Text style={styles.locationText}>{stream.location}</Text>
            </View>

            {/* Quality Info */}
            <View style={styles.qualityContainer}>
              <Ionicons name="musical-notes" size={16} color="#666" />
              <Text style={styles.qualityText}>High Quality • {stream.quality}</Text>
            </View>
        ...
        <Card style={styles.infoCard}>
          <Card.Content>
            ...
            <View style={styles.infoRow}>
              ...
              <Text style={styles.infoText}>Background playback supported</Text>
            </View>
            <View style={styles.infoRow}>
              <Ionicons name="wifi-outline" size={20} color={theme.colors.primary} />
              <Text style={styles.infoText}>Requires internet connection</Text>
            </View>
          </Card.Content>
        </Card>
      </View>
